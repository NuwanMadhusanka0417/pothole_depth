...
from pothole_vision.video.ffprobe_io import file_container_hint
    ...
    for video_path in videos:
        try:
            ...
            print(json.dumps({
                "path": str(video_path),
                "error": str(e),
                "on_disk": file_container_hint(video_path),
            }, indent=2))
            print()

    print(f"--- ok={ok_count} failed={fail_count} total={len(videos)} ---")
